...
var RoverSelector = function (_c) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: 'selector' },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("select", { value: rover, onChange: function (e) { return handleSelectChange(e.currentTarget.value); } }, options.map(function (item, i) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("option", { value: item, key: item }, item)); }))));
};
_a = RoverSelector;
...
//# sourceMappingURL=src_scene_Manifest_ManifestPage_tsx.c854be053c6e4bc08175.hot-update.js.map