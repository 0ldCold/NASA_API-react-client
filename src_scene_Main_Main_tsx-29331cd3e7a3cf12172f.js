...
var Main = function () {
    ...
    var getRandomPhotoFromAPI = function () { return __awaiter(void 0, void 0, void 0, function () {
        var apiResp;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    apiResp = _c.sent();
                    return [2, randomPhotoFromPhotosArr(apiResp).img_src];
            }
        });
    }); };
    var handleButton = function () {
        getRandomPhotoFromAPI().then(function (randomImg) { return setImg(randomImg); });
    };
...
//# sourceMappingURL=src_scene_Main_Main_tsx-29331cd3e7a3cf12172f.js.map