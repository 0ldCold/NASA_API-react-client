...
var API_URL = "https://mars-photos.herokuapp.com/api/v1";
...
"use strict";
module.exports = JSON.parse('{"_from":"axios@^0.21.1","_id":"axios@0.21.4","_inBundle":false,"_integrity":"sha512-ut5vewkiu8jjGBdqpM44XxjuCjq9LAKeHVmoVfHVzy8eHgxxq8SbAVQNovDA8mVi05kP0Ea/n/UzcSHcTJQfNg==","_location":"/axios","_phantomChildren":{},"_requested":{"type":"range","registry":true,"raw":"axios@^0.21.1","name":"axios","escapedName":"axios","rawSpec":"^0.21.1","saveSpec":null,"fetchSpec":"^0.21.1"},"_requiredBy":["/"],"_resolved":"https://registry.npmjs.org/axios/-/axios-0.21.4.tgz","_shasum":"c67b90dc0568e5c1cf2b0b858c43ba28e2eda575","_spec":"axios@^0.21.1","_where":"D:\\\\projects\\\\NASA_API-react-client","author":{"name":"Matt Zabriskie"},"browser":{"./lib/adapters/http.js":"./lib/adapters/xhr.js"},"bugs":{"url":"https://github.com/axios/axios/issues"},"bundleDependencies":false,"bundlesize":[{"path":"./dist/axios.min.js","threshold":"5kB"}],"dependencies":{"follow-redirects":"^1.14.0"},"deprecated":false,"description":"Promise based HTTP client for the browser and node.js","devDependencies":{"coveralls":"^3.0.0","es6-promise":"^4.2.4","grunt":"^1.3.0","grunt-banner":"^0.6.0","grunt-cli":"^1.2.0","grunt-contrib-clean":"^1.1.0","grunt-contrib-watch":"^1.0.0","grunt-eslint":"^23.0.0","grunt-karma":"^4.0.0","grunt-mocha-test":"^0.13.3","grunt-ts":"^6.0.0-beta.19","grunt-webpack":"^4.0.2","istanbul-instrumenter-loader":"^1.0.0","jasmine-core":"^2.4.1","karma":"^6.3.2","karma-chrome-launcher":"^3.1.0","karma-firefox-launcher":"^2.1.0","karma-jasmine":"^1.1.1","karma-jasmine-ajax":"^0.1.13","karma-safari-launcher":"^1.0.0","karma-sauce-launcher":"^4.3.6","karma-sinon":"^1.0.5","karma-sourcemap-loader":"^0.3.8","karma-webpack":"^4.0.2","load-grunt-tasks":"^3.5.2","minimist":"^1.2.0","mocha":"^8.2.1","sinon":"^4.5.0","terser-webpack-plugin":"^4.2.3","typescript":"^4.0.5","url-search-params":"^0.10.0","webpack":"^4.44.2","webpack-dev-server":"^3.11.0"},"homepage":"https://axios-http.com","jsdelivr":"dist/axios.min.js","keywords":["xhr","http","ajax","promise","node"],"license":"MIT","main":"index.js","name":"axios","repository":{"type":"git","url":"git+https://github.com/axios/axios.git"},"scripts":{"build":"NODE_ENV=production grunt build","coveralls":"cat coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js","examples":"node ./examples/server.js","fix":"eslint --fix lib/**/*.js","postversion":"git push && git push --tags","preversion":"npm test","start":"node ./sandbox/server.js","test":"grunt test","version":"npm run build && grunt version && git add -A dist && git add CHANGELOG.md bower.json package.json"},"typings":"./index.d.ts","unpkg":"dist/axios.min.js","version":"0.21.4"}');
...
/******/ 			return "" + chunkId + "-" + {"413":"10b470ac95e949304af3","983":"f34e9042cb79f668708b"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 			// return url for filenames based on template
/******/ 			return "" + "main" + "-" + "392befe90b878e45a2fd" + ".css";
/******/ 		};
/******/ 	})();
/******/ 	
...
;// CONCATENATED MODULE: ./src/utils/store/constants/app.ts
var SET_MODAL = "SET_MODAL";

;// CONCATENATED MODULE: ./src/utils/store/actions/app/index.ts

var actionSetModal = function (modal) { return ({
    type: SET_MODAL,
    modal: modal
}); };

;// CONCATENATED MODULE: ./src/components/base/ModalProvider/ModalProvider.tsx
...
var ModalProvider = function (_a) {
    ...
    return (react.createElement(react.Fragment, null,
        react.createElement((lib_default()), { isOpen: modal === "main", contentLabel: 'Main', shouldCloseOnEsc: true, shouldCloseOnOverlayClick: false, onRequestClose: function () { return dispatch(actionSetModal("disabled")); }, className: 'modal', overlayClassName: 'modalContainer' }, "main modal window"),
        children));
};
/* harmony default export */ const ModalProvider_ModalProvider = (ModalProvider);
...
var developmentOnly = __webpack_require__(9804);
...
;// CONCATENATED MODULE: ./src/utils/store/reducers/AppReducer/index.ts
...
var AppReducer = function (state, action) {
    ...
    switch (action.type) {
        case SET_MODAL: {
            return __assign(__assign({}, state), { modal: action.modal });
        }
        default:
            return state;
    }
};
/* harmony default export */ const reducers_AppReducer = (AppReducer);

;// CONCATENATED MODULE: ./src/utils/store/index.ts




var allReducers = (0,redux/* combineReducers */.UY)({
    app: reducers_AppReducer
});
var loadState = function () {
    try {
        ...
        var fullState = JSON.parse(serializedState);
        return fullState;
    }
    catch (err) {
        return undefined;
...
var store = (0,redux/* createStore */.MT)(allReducers, persistedState, (0,developmentOnly/* composeWithDevTools */.Uo)((0,redux/* applyMiddleware */.md)(es)));
store.subscribe(function () {
    saveState({
        app: store.getState().app
    });
});
/* harmony default export */ const utils_store = (store);

// EXTERNAL MODULE: ./src/utils/api/instance.ts
var instance = __webpack_require__(7723);
;// CONCATENATED MODULE: ./src/routing/Routes.tsx


var Main = react.lazy(function () { return __webpack_require__.e(/* import() */ 413).then(__webpack_require__.bind(__webpack_require__, 6413)); });
var NotFound = react.lazy(function () {
    return __webpack_require__.e(/* import() */ 983).then(__webpack_require__.bind(__webpack_require__, 983));
});
var Routes = function () {
    return (react.createElement(react.Suspense, { fallback: react.createElement("div", null, "loader") },
...
/* harmony default export */ const routing_Routes = (Routes);

;// CONCATENATED MODULE: ./src/components/providers/AppContainer.tsx




var AppContainer = function () {
    instance/* instance.interceptors.request.use */.e.interceptors.request.use(function (config) {
        var modConfig = config;
        if (utils_store.getState().app.baseURL) {
            modConfig.baseURL = utils_store.getState().app.baseURL + "/api/";
        }
        return modConfig;
    });
    return (react.createElement(react.Fragment, null,
        react.createElement(routing_Routes, null)));
};
/* harmony default export */ const providers_AppContainer = (AppContainer);
...
var App = function () {
    return (react.createElement(components_Provider, { store: utils_store },
        react.createElement(BrowserRouter, null,
            react.createElement(ModalProvider_ModalProvider, null,
                react.createElement(providers_AppContainer, null)))));
};
...
react_dom.render(react.createElement(app, null), document.querySelector("#root"));

})();

/******/ })()
;
//# sourceMappingURL=main-0962cbb564d390d66e85.js.map