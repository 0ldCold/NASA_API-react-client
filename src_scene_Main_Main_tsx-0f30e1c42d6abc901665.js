...
var Main = function () {
    ...
    var randomPhotoFromPhotosArr = function (photos) {
        return photos[Math.floor(Math.random() * photos.length)];
    };
    var getRandomPhoto = function () { return __awaiter(void 0, void 0, void 0, function () {
        var apiResp, randomIndex;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4, (0,src_api_photosEndPoint__WEBPACK_IMPORTED_MODULE_0__.getPhotosEndPoint)(rover, 1000)];
                case 1:
                    apiResp = _c.sent();
    ...
    var handleButton = function () {
        getRandomPhoto().then(function (randomImg) { return setImg(randomImg); });
    };
...
//# sourceMappingURL=src_scene_Main_Main_tsx-0f30e1c42d6abc901665.js.map