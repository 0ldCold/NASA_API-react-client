...
var getManifest = function (roverName) {
    _instance__WEBPACK_IMPORTED_MODULE_0__.instance.get("https://mars-photos.herokuapp.com/api/v1/manifests/" + roverName).then(function (res) {
        res = res.data;
        return res;
    });
};
...
//# sourceMappingURL=src_scene_Main_Main_tsx-bb677a3c5d0bfdf97660.js.map