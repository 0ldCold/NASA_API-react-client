...
var RoverSelector = function (_b) {
    var onSelect = _b.onSelect, value = _b.value, options = _b.options;
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_ToggleButtonGroup__WEBPACK_IMPORTED_MODULE_1__["default"], { color: 'secondary', value: value, exclusive: true, onChange: function (e, newValue) { return onSelect(newValue); } }, options.map(function (name) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_ToggleButton__WEBPACK_IMPORTED_MODULE_2__["default"], { value: name }, name)); })));
};
_a = RoverSelector;
...
//# sourceMappingURL=src_scene_Manifest_ManifestPage_tsx-c92a2bd5ce387aa12f22.js.map