    ...
    var getRandomPhoto = function (roverName) { return __awaiter(void 0, void 0, Promise, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    apiResp = _d.sent();
                    return [2, (_c = apiResp[Object(function webpackMissingModule() { var e = new Error("Cannot find module 'utils/utils'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(0, apiResp.length - 1)]) === null || _c === void 0 ? void 0 : _c.img_src];
            }
        });
    }); };
...
var RoverSelector = function (_b) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: 'selector' },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("select", { onChange: function (e) { return handleSelectChange(e.currentTarget.value); } }, options.map(function (item) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("option", { value: item, key: item }, item)); }))));
};
_a = RoverSelector;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var components_RandomPhoto_randomPhoto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! components/RandomPhoto/randomPhoto */ "./src/components/RandomPhoto/randomPhoto.tsx");
...
var Main = function () {
    return react__WEBPACK_IMPORTED_MODULE_1__.createElement(components_RandomPhoto_randomPhoto__WEBPACK_IMPORTED_MODULE_0__["default"], null);
};
_a = Main;
...
//# sourceMappingURL=src_scene_Main_Main_tsx-c35943fe5ad89b6c14fa.js.map