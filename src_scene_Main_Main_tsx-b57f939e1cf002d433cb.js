...
var getManifest = function (roverName) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                result = _b.sent();
                result = result.data.photo_manifest;
                if (!result)
                    throw new Error("Данных нет");
                return [2, (_a = result.data.photo_manifest) !== null && _a !== void 0 ? _a : result.data];
        }
    });
}); };
...
//# sourceMappingURL=src_scene_Main_Main_tsx-b57f939e1cf002d433cb.js.map