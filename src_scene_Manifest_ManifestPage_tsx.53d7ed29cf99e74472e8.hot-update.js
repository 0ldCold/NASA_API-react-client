...
var RoverSelector = function (_c) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: 'selector' },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("select", { value: rover, onCChange: function (e) { return handleSelectChange(e.currentTarget.value); } }, options.map(function (item, i) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("option", { value: item, key: item }, item)); }))));
};
_a = RoverSelector;
...
//# sourceMappingURL=src_scene_Manifest_ManifestPage_tsx.53d7ed29cf99e74472e8.hot-update.js.map